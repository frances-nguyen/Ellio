...
import com.jenho.framework.animation.Animation;
import com.jenho.framework.animation.Frame;

public class Assets {

    private static SoundPool soundPool;
    public static Bitmap welcome, block, cloud1, cloud2, duck, grass, jump, run1, run2, run3, run4,
    run5, scoreDown, score, startDown, start;
    ...
    /* Perform image load in 3 steps:
     * First, creates InputStream object (read data from device's file system).
     * Then, creates an Options object that specifies how that image should be stored in memory.
     * Finally, create a new Bitmap using the BitmapFactory class, passing in InputStream and Options are arguments.
     */
