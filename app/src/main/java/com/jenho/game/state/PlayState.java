...
public class PlayState extends State {
    ...
    private float recentTouchY; //Store the Y-coordinate of the most recent touch down event.
    ...
    /*
    onTouch will implement swipe control. First, store the Y-coordinate of the most recent
    touch down event. Later, when a touch up even is detected, compare its Y-coordinate to
    the stored Y-coordinate of the most recent touch down event--the difference of the two values
    is the swipe distance. If swipe distance is greater than 50 pixels, Ellio will jummp or duck
    depending on direction of the swipe.
     */
    @Override
